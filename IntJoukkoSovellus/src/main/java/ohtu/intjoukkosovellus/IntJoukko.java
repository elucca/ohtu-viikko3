...
public class IntJoukko {
    ...
    public IntJoukko() {
        this.lukujono = alustaLukujono(KAPASITEETTI);
        this.alkioidenLkm = 0;
    ...
    public boolean lisaa(int[] luvut) {
        for (int i : luvut) {
            if (!lisaa(i)) {
                return false;
            }
    ...
    public boolean poista(int[] luvut) {
        for (int i : luvut) {
            if (!poista(i)) {
                return false;
            }
    ...
    public static IntJoukko yhdiste(IntJoukko a, IntJoukko b) {
        ...
        yhdiste.lisaa(aTaulu);
        yhdiste.lisaa(bTaulu);
